...
#  loadImgs   - Load test_vid with the specified ids.
...
class COCO:
    ...
    def getAnnIds(self, imgIds=[], catIds=[], areaRng=[], iscrowd=None):
        ...
        :param imgIds  (int array)     : get anns for given test_vid
    ...
    def getImgIds(self, imgIds=[], catIds=[]):
        ...
        :param imgIds (int array) : get test_vid for given ids
        :param catIds (int array) : get test_vid with all given cats
    ...
    def loadImgs(self, ids=[]):
        ...
        :return: test_vid (object array) : loaded img objects
        """
        if type(ids) == list:
