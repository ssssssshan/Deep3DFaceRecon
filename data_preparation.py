...
def data_prepare(folder_list,mode):
    ...
    lms_dlib_list=[i.replace('landmarks', 'landmarks_dlib') for i in lms_list]
    
    lms_dlib_list_final,lms_list_final, imgs_list_final, msks_list_final = check_list(lms_dlib_list, lms_list, imgs_list, msks_list) # check if the path is valid
    write_list(lms_dlib_list_final,lms_list_final, imgs_list_final, msks_list_final, mode=mode) # save files
