            ...
            for i in range(image.shape[0]):
                ...
                if save_results:
                    ...
                    if name is not None:
                        ...
                        # img_path_input = os.path.join(save_path, '%s_input.png' % name)
                        # img_path_output = os.path.join(save_path, '%s_output.png' % name)
                        # util.save_image(image_numpy[:, :224, :], img_path_input)
                        # util.save_image(image_numpy[:, 224:448, :], img_path_output)
                    else:
